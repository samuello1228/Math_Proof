...
void logic(vector<Definition*>& All_Definition, vector<Axiom*>& All_Axiom, vector<Proposition*>& All_Proposition)
{
    ...
    block->append_binary_operator({1}, law, {{1},{2}}, LeftToRight, true, true);
    x->append(block);
    */
    ...
    block->append_binary_operator({}, law, {{1,1},{1,2},{2}}, LeftToRight, false, true);
    law = FindByRef<Proposition>(All_Proposition, "lor_complement_2");
    block->append_binary_operator({2}, law, {{2}}, LeftToRight, false, true);
    law = FindByRef<Proposition>(All_Proposition, "land_identity_1");
    block->append_binary_operator({}, law, {{1}}, LeftToRight, true, true);
    x->append(block, true);
    Proposition::addProposition(All_Proposition, fout, x);
    ...
    block->append_binary_operator({}, law, {{1},{1}}, LeftToRight, false, true);
    law = FindByRef<Proposition>(All_Proposition, "land_idempotence");
    block->append_binary_operator({1}, law, {{1}}, LeftToRight, false, true);
    block->append_binary_operator({2}, law, {{1}}, LeftToRight, false, true);

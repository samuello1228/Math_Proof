...
\begin{prop}
\label{Proposition:substitution_of_equality}
Substitution of $=$.
\begin{align*}
& \forall a \forall b ( \\
& & & a = b \\
...
& & \implies & (\forall c (a = b)) \implies (\forall c ((a = c) \iff (b = c)))
& & \text{Proposition \ref{Proposition:implies_substitution_forall_2}} \\
& )
\end{align*}
\end{prop}
...
& & \text{Proposition \ref{Proposition:substitution_of_equality}} \\
